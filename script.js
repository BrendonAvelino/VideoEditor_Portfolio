document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            testimonial_quote_juliana: '"Brendon delivered a very well-edited video, with exactly the vibe I wanted for my channel. The editing was clean, fluid, and just right, showing care in every detail. He also respected the deadline perfectly, which helped me a lot with my schedule."',
            testimonial_role_juliana: "Social Media",
            testimonial_quote_micael: '"Man, it was great working with Brendon. The editing of my videos was super pleasant and fun, he managed to add a special touch that I didn\'t expect. The final video turned out great and the editing was top-notch. Best of all, he delivered on time, no stress. Highly recommend!"',
            testimonial_role_micael: "Streamer",
        ...
        pt: {
            ...
            testimonial_quote_juliana: '"O Brendon entregou um vídeo muito bem editado, com exatamente a vibe que eu queria pro meu canal. A edição ficou limpa, fluida e do jeitinho certo, mostrando cuidado em cada detalhe. Ele também respeitou o prazo certinho, o que me ajudou muito na organização."',
            testimonial_role_juliana: "Social Media",
            testimonial_quote_micael: '"Cara, foi muito bom trabalhar com o Brendon. A edição dos meus vídeos ficou super agradável e divertida, ele conseguiu dar um toque especial que eu não esperava. O vídeo final ficou muito legal e a edição foi de primeira. O melhor de tudo é que ele entregou no prazo, sem estresse. Recomendo demais!"',
            testimonial_role_micael: "Streamer",
